...
<footer class="text-gray-300 bg-gray-900">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid gap-8 md:grid-cols-4">
            <div>
                <img src="{{ asset('brand/front/ManucoreLogo.png') }}" 
                     alt="{{ config('app.name', 'ManuCore ERP') }}" 
                     class="h-8 mb-4">
                <p class="text-sm">Intelligent Manufacturing Resource Planning for modern manufacturers.</p>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('integrations') }}" class="hover:text-white">Integrations</a></li>
                    <li><a href="{{ route('api-docs') }}" class="hover:text-white">API Documentation</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('status') }}" class="hover:text-white">System Status</a></li>
                </ul>
            </div>
        </div>
        
        <div class="pt-8 mt-8 text-sm text-center border-t border-gray-800">
            <p>&copy; {{ date('Y') }} {{ config('app.name', 'ManuCore ERP') }}. All rights reserved. | Powered by IBEZ Solutions</p>
        </div>
    </div>
</footer>